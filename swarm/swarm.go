...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *ethereumclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
